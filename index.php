    ...
    <div class="page-header header-filter">
      ...
      <div class="container">
        <div class="content-center brand">
          <h1 class="h1-seo">• Kelompok 2 •</h1>
          <h3>Mencari kata dasar dari suatu dokumen menggunakan algoritma Tala & ECHS.</h3>
            <form method="post" action="document.php">
          <button type ="submit" class="btn btn-primary btn-round" type="button" href="document.php">Mulai</button>
          </form>
